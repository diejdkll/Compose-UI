...
//    )
    ...
    // 스텝 2: Color 객체를 이용해서 해쉬값으로 색상을 전달 (ARGB 순)
//    Text(
//        text = "Hello $name",
...
//    )
    ...
    // 스텝 5: fontFamily에 FontFamily.Cursive를 전달
//    Text(
//        text = "Hello $name",
//        color = Color(0xffff9944),
//        fontSize = 30.sp,
...
//    )
    ...
    // 스텝 7: maxLines를 2로 지정하고 문자열을 더 추가
//    Text(
//        text = "Hello $name\nHello $name\nHello $name",
//        color = Color(0xffff9944),
//        fontSize = 30.sp,
...
//    )
    ...
    // 스텝 8: textDecoration에 TextDecoration.Underline을 추가
//    Text(
//        text = "Hello $name\nHello $name\nHello $name",
//        color = Color(0xffff9944),
//        fontSize = 30.sp,
...
//    )
    ...
    // 스텝 9: textAlign을 TextAlign.Center로 지정
